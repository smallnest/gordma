// Command go-send_bw is a Go reimplementation of perftest's ib_send_bw: it
...
func main() {
	cfg, err := perftest.ParseArgs("go-send_bw", os.Args[1:], os.Stderr)
	if err != nil {
		os.Exit(2)
	}
	if err := run(cfg); err != nil {
		fmt.Fprintf(os.Stderr, "go-send_bw: %v\n", err)
		os.Exit(1)
	}
}
