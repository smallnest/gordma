...
const TOC = [
  ...
  },
  {
    ...
    pages: [
      ...
      { id: "p2-lowlevel-recipe",title: "底层实战：手写 RC 收发", file: "p2-lowlevel-recipe.html" },
      { id: "p2-rdmanet",        title: "高层 rdmanet",        file: "p2-rdmanet.html" },
      { id: "p2-rdmanet-recipe", title: "高层实战：动手写业务", file: "p2-rdmanet-recipe.html" },
  ...
  },
  {
    ...
    pages: [
      ...
      { id: "p3-cgo-overhead", title: "为何慢于原生 RDMA",  file: "p3-cgo-overhead.html", section: "工具" },
