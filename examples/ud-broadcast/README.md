...
go run . -r 192.0.2.1:9100 -name node1
go run . -r 192.0.2.1:9100 -name node2
go run . -r 192.0.2.1:9100 -name node3

# 3. sender fans out to all of them
go run . -r 192.0.2.1:9100 -to node1,node2,node3 -send
```
