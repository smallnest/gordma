...
var (
	...
	n        = flag.IntP("count", "n", 100000, "number of messages")
	size     = flag.IntP("size", "s", 1024, "message size in bytes")
	batch    = flag.IntP("batch", "b", 32, "batch size for the SendBatch pass")
